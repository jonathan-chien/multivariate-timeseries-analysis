function binned_timeseries = bin_data(timeseries, bin_width, step_size)
% Accepts an n_vars x n_timepoints array, and bins according to specified
% number of bins, bin width and step size.
% 
% PARAMETERS
% ----------
...
[n_timepts_to_use, n_bins] ...
    = determine_n_bins(size(timeseries, 2), bin_width, step_size);
